...
CREATE EXTERNAL TABLE campaign_finance_external.pac_to_candidate_contributions_crp (
    cycle STRING,
    fec_rec_no STRING,
    pac_id STRING,
    cid STRING,
...
CREATE EXTERNAL TABLE campaign_finance_external.pac_intra_contributions_crp(
    cycle STRING,
    fec_rec_no STRING,
    file_rid STRING,
    donor_cmte STRING,
