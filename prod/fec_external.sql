CREATE DATABASE IF NOT EXISTS fec_external;

CREATE EXTERNAL TABLE IF NOT EXISTS fec_external.pac_committee_master (
...
LOCATION 's3n://poliana.prod/campaign_finance/fec/committee_master/data/';


CREATE EXTERNAL TABLE IF NOT EXISTS fec_external.pac_candidate_master (
...
LOCATION 's3n://poliana.prod/campaign_finance/fec/candidate_master/data/';


CREATE EXTERNAL TABLE IF NOT EXISTS fec_external.pac_to_pac_contributions (
...
LOCATION 's3n://poliana.prod/campaign_finance/fec/other/data/';


CREATE EXTERNAL TABLE IF NOT EXISTS fec_external.pac_to_candidate_contributions (
    cmte_id STRING COMMENT 'Filer Identification Number',
    amndt_ind STRING COMMENT 'Amendment Indicator Indicates if the report being filed is new (N), an amendment (A) to a previous report, or a termination (T) report.',
    rpt_tp STRING COMMENT 'Report Type Indicates the type of report filed. List of report type codes',
    transaction_pgi STRING COMMENT 'Primary-General Indicator This code indicates the election for which the contribution was made. EYYYY (election Primary, General, Other plus election year)',
...
LOCATION 's3n://poliana.prod/campaign_finance/fec/pas/data/';


CREATE EXTERNAL TABLE IF NOT EXISTS fec_external.individual_contributions (
    cmte_id STRING COMMENT 'Filer Identification Number',
    amndt_ind STRING COMMENT 'Amendment Indicator Indicates if the report being filed is new (N), an amendment (A) to a previous report, or a termination (T) report.',
    rpt_tp STRING COMMENT 'Report Type Indicates the type of report filed. List of report type codes',
    transaction_pgi STRING COMMENT 'Primary-General Indicator This code indicates the election for which the contribution was made. EYYYY (election Primary, General, Other plus election year)',
...
LOCATION 's3n://poliana.prod/campaign_finance/fec/individuals/data/';


CREATE EXTERNAL TABLE IF NOT EXISTS fec_external.pac_campaign_summaries_current (
    cand_id STRING COMMENT 'Candidate Identification',
    cand_name STRING COMMENT 'Candidate Name',
...
LOCATION 's3n://poliana.prod/campaign_finance/fec/campaign_summaries_current/data/';


CREATE EXTERNAL TABLE IF NOT EXISTS fec_external.pac_campaign_summaries_all (
    cand_id STRING COMMENT 'Candidate Identification',
    cand_name STRING COMMENT 'Candidate Name',
    cand_ici STRING COMMENT 'Incumbent Challenger Status',
    pty_cd STRING COMMENT 'Party Code',
...
LOCATION 's3n://poliana.prod/campaign_finance/fec/campaign_summaries_all/data/';


CREATE EXTERNAL TABLE IF NOT EXISTS fec_external.pac_summaries (
    cmte_id STRING COMMENT 'Committee Identification',
    cmte_nm STRING COMMENT 'Committee Name',
    cmte_tp STRING COMMENT 'Committee Type',
    cmte_dsgn STRING COMMENT 'Committee Designation',
...
LOCATION 's3n://poliana.prod/campaign_finance/fec/pac_summaries/data/';
